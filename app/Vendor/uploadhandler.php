    ...
    function __construct($options=null) {
        $this->options = array(        	
            ...
            'image_versions' => array(
                ...
                /*
                'resized' => array(
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/img/upload/',
                    'upload_url' => $this->getFullUrl().'/img/upload/',
                    'max_width' => 1000,
                    'max_height' => 1000,
                    'jpeg_quality' => 95
                ),
				*/
                'thumbnail' => array(
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/img/upload/thumbnails/',
                    'upload_url' => $this->getFullUrl().'/img/upload/thumbnails/',
                    'max_width' => 80,
                    'max_height' => 80
                )
            )
